...
let handler = async (message, { conn }) => {
  let packsRaw = await (await fetch("https://raw.githubusercontent.com/Afghhjjkoo/GURU-BOT/main/lib/5%D8%AA%D8%B7%D9%82%D9%8A%D9%85.json")).json();
